...
build() {
    ...
    # WolfSSL + Helium
    export WOLF_FLAGS="-fPIC -D_FORTIFY_SOURCE=2 -DWOLFSSL_MIN_RSA_BITS=2048 -DWOLFSSL_MIN_ECC_BITS=256 -DWOLFSSL_NO_SPHINCS -DWOLFSSL_TLS13_MIDDLEBOX_COMPAT -DWOLFSSL_APPLE_NATIVE_CERT_VALIDATION -DWOLFSSL_TRUST_PEER_CERT"
